...
public class Code {
  ...
  public static final byte setBigEndian(byte b, boolean bigEndian)
  {
    return bigEndian ? (byte)(b | BIGENDIAN_MASK) : (byte)(b & (~BIGENDIAN_MASK));
  }

  public static final boolean getBigEndian(byte b)
  {
    return (b & BIGENDIAN_MASK) == BIGENDIAN_MASK;
  }
